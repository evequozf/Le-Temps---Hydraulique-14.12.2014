    ...
    chardinJs = (function() {
      ...
      chardinJs.prototype._add_overlay_layer = function() {
        ...
        if (this.$el.prop('tagName') === "BODY") {
          ...
          if (element_position) {
            styleText += "width: " + element_position.width + "px; height:" + element_position.height + "px; top:" + element_position.top + "px;left: " + (element_position.left+15) + "px;";
            overlay_layer.setAttribute("style", styleText);
          }
        }
      ...
      chardinJs.prototype._position_helper_layer = function(element) {
        ...
        element_position = this._get_offset(element);
				switch (this._get_position(element)) {
					case "insideMiddle":
						return helper_layer.setAttribute("style", "width: " + (element_position.width+20) + "px; height:" + element_position.height + "px; top:" + element_position.top + "px; left: " + element_position.left + "px;");
					case "insideTop":
						return helper_layer.setAttribute("style", "width: " + (element_position.width-10) + "px; height:" + element_position.height + "px; top:" + element_position.top + "px; left: " + element_position.left + "px;");
					case "insideRight":
						return helper_layer.setAttribute("style", "width: " + (element_position.width+20) + "px; height:" + element_position.height + "px; top:" + (element_position.top+5) + "px; left: " + element_position.left + "px;");
					case "insideLeft":
						return helper_layer.setAttribute("style", "width: " + (element_position.width-10) + "px; height:" + (element_position.height-5) + "px; top:" + (element_position.top+5) + "px; left: " + element_position.left + "px;");
					case "buttonOK":
						return helper_layer.setAttribute("style", "width: " + (element_position.width) + "px; height:" + (element_position.height-5) + "px; top:" + (element_position.top+51) + "px; left: " + (element_position.left-18) + "px;");
				}	
      };

      chardinJs.prototype._show_element = function(element) {
        var current_element_position, element_position, helper_layer, tooltip_layer, _this = this;
